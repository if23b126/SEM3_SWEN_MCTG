...
public class GameRepositoryTest {
    ...
    static monstercardtradinggametest.persistence.GameRepositoryTest gameRepositoryTest;
    ...
    public void checkIfTradingExistsTrueTest() {
        boolean exists = gameRepository.checkIfTradingExists("6cd85277-4590d-49d4-b0cf-ba0a9f1faad0");
